...
var Mesh = require("../models/mesh-type.model");

function createDefaultMeshType() {

    Mesh.find().exec(function (err, collection) {
        if (collection.length == 0) {
            ...
            Mesh.create({name: 'Building', value: 0.1});
            Mesh.create({name: 'Govermental', value: 3});
            Mesh.create({name: 'Forbidden', value: 3});
...
module.exports.createDefaultMeshType = createDefaultMeshType;
